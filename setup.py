...
if 'bdist_wheel' in sys.argv:
    ...
    for directory in ('build', 'dist', 'python_log_async.egg-info'):
...
setup(
    ...
    packages=['log_async'],
    version=VERSION,
    description='Asynchronous Python logging handler (based on logstash_async).',
    long_description=LONG_DESCRIPTION,
    license='MIT',
    author='Enrico Tröger',
    author_email='enrico.troeger@uvena.de',
    url='https://github.com/iskme/python-log-async',
